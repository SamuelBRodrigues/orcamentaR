...
LISTA_PAGINAS <- list(  
  list(
    url = "https://planejamento.rs.gov.br/plano-plurianual",
    seletor = '#panel-1681416729936 > div a, #panel-1681417459335 > div a, #panel-1734638379624 > div a',
    periodo = "2024-2027"), 

  list(
    url = "https://planejamento.rs.gov.br/plano-plurianual",
    seletor = '#panel-1633638906495 > div a, #panel-1633639736683 > div a, #panel-1633639858190 > div a',
    periodo = "2020-2023"
  ),
  
  list(
    url = "https://planejamento.rs.gov.br/plano-plurianual-2016-2019",
    seletor = '#panel-1588964117285 > div a',
    periodo = "2016-2019"
  ),
  
  list(
    url = "https://planejamento.rs.gov.br/plano-plurianual-2012-2015",
    seletor = '#bodyPrincipal > div.wrapper__corpo > div > div:nth-child(1) > article > div.artigo__texto > div a',
    periodo = "2012-2015"
  ),
  
  list(
    url = "https://planejamento.rs.gov.br/plano-plurianual-2008-2011",
    seletor = '#bodyPrincipal > div.wrapper__corpo > div > div:nth-child(1) > article > div.artigo__texto > div a',
    periodo = "2008-2011"
  ),
  
  list(
    url = "https://planejamento.rs.gov.br/plano-plurianual-2004-2007",
    seletor = '#bodyPrincipal > div.wrapper__corpo > div > div:nth-child(1) > article > div.artigo__texto > div a',
    periodo = "2004-2007"
  )
)
...
main <- function() {
  message("\n✨ Iniciando coleta de arquivos PPA-RS ✨")
