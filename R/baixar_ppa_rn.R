...
LISTA_PAGINAS <- list(  
  list(
    url = "https://transparencia.tjrn.jus.br/index.php/gestao-orcamentaria-e-financeira/plano-plurianual-ppa",
    seletor = '#inner_content > div > div > div.mx-component-area-inner.clearfix > article > ul:nth-child(5) a',
    periodo = "2024-2027"), 

  list(
    url = "https://transparencia.tjrn.jus.br/index.php/gestao-orcamentaria-e-financeira/plano-plurianual-ppa",
    seletor = '#inner_content > div > div > div.mx-component-area-inner.clearfix > article > ul:nth-child(7) a',
    periodo = "2020-2023"
  ),
  
  list(
    url = "https://transparencia.tjrn.jus.br/index.php/gestao-orcamentaria-e-financeira/plano-plurianual-ppa",
    seletor = '#inner_content > div > div > div.mx-component-area-inner.clearfix > article > ul:nth-child(9) a',
    periodo = "2016-2019"
  )
)
